...
{
	public class CreateGDbcContainerServiceBuilder
	{
		...
		/// <inheritdoc />
		public CreateGDbcContainerServiceBuilder([NotNull] ApplicationConfiguration config, [NotNull] Type dbcType)
		{
		...
		private void RegisterNonGenericDbcModelServices(ContainerBuilder builder, Type dbcType)
		{
			...
			builder.RegisterType(typeof(StreamBasedGDbcEntryWriter<>).MakeGenericType(dbcType))
